...
<html>
  ...
  <body>
<form action="<%=basePath%>customer/cusAdd.do"  name="form1" onsubmit="return validator(this)" method="post" >
<table class=editTable cellSpacing=1 cellPadding=0 width="100%" align=center border=0>
    ...
    <tr>
		...
		<td width="33%" colspan="3" bgcolor="#FFFFFF"><select name="sourceId" style=" width: 145px">
		<c:forEach var="source" items="${data.sources }">
				<option value="${source.sourceId }" label="">${source.sourceName }</option>
		</c:forEach>
		</select>	  </td>
    </tr>
    ...
    <tr>
		...
		<td colspan="3" bgcolor="#FFFFFF"><select name="typeId" style=" width: 145px">
		<c:forEach var="type" items="${data.types }">
				<option value="${type.typeId }" label="">${type.typeName }</option>
		</c:forEach>
		</select>		</td>
    </tr>
	<tr>
	...
	<tr>
		...
		<td colspan="3" bgcolor="#FFFFFF"><select name="conditionId" style=" width: 145px">
    ...
    <tr>
		...
		<td colspan="3" bgcolor="#FFFFFF"><input type="text"  maxlength="10"  style=" width: 145px" valid="required"  errmsg="创建人不能为空!"  name="customerAddMan" value="${sessionScope.userInfo.userName }"></td>
	...
	<tr>
		...
		<input type="hidden"    value="${sessionScope.userInfo.userId }"  name="userId" >
