...
<table class=editTable cellSpacing=1 cellPadding=0 width="100%" align=center border=0>
    ...
    <tr>
		...
		<td colspan="3" bgcolor="#FFFFFF"><input type="text"   maxlength="10"  style=" width: 145px"  name="customerName"></td>
	 	 <td width="13%" bgcolor="#FFFDF0"><div align="center">关怀途径：</div></td>
		<td width="33%" colspan="3" bgcolor="#FFFFFF">
		<input type="text"   maxlength="10"  style=" width: 145px"  name="customerName">	  </td>
    </tr>
	
	
	<tr>
		<td bgcolor="#FFFDF0"><div align="center">关怀日期：</div></td>
		...
		<td bgcolor="#FFFDF0"><div align="center">客户编号：</div></td>
